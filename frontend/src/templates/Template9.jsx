  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderColor: "#1e3a8a" /* navy-700 */ }}
      >
        {formData.name && (
          <h1
            className="text-3xl font-bold"
            style={{ color: "#1e40af" /* navy-800 */ }}
          >
            {formData.name}
          </h1>
        )}
        ...
        <div className="mb-6">
          <h2
            ...
            style={{
              ...
              borderColor: "#cbd5e1", // navy-300
            }}
          >
            Profile Summary
          </h2>
          <p style={{ color: "#374151" /* gray-700 */ }}>
            {formData.objective}
          </p>
        </div>
      )}
      ...
      {formData.education.length > 0 && (
        <div className="mb-6">
          ...
          {formData.education.map((edu, index) => (
            <div key={index} className="mb-4">
              <p style={{ color: "#1f2937", fontWeight: "500" /* gray-800 */ }}>
                {edu.institution}
              </p>
              <p style={{ color: "#374151" /* gray-700 */ }}>{edu.degree}</p>
              <p style={{ color: "#4b5563" /* gray-600 */ }}>{edu.year}</p>
              {edu.cgpa && (
      ...
      {formData.skills.length > 0 && (
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            {formData.skills.map((skill, index) => (
              <span key={index} style={{ color: "#374151" /* gray-700 */ }}>
                {skill}
              </span>
            ))}
          </div>
        ...
        <div className="mb-6">
          ...
          {formData.experience.map((exp, index) => (
            <div key={index} className="mb-4">
              ...
              <p style={{ color: "#374151" /* gray-700 */ }}>{exp.role}</p>
              <p style={{ color: "#4b5563" /* gray-600 */ }}>{exp.duration}</p>
              {exp.description && (
                <p style={{ color: "#374151" /* gray-700 */ }}>
                  {exp.description}
                </p>
