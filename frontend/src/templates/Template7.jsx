...
function Template7({ formData }) {
  return (
    <div className="min-h-[297mm] w-[210mm] bg-white p-8 shadow-lg font-sans">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-6 mb-6 rounded-t-lg">
      ...
      {formData.objective && (
        <div className="mb-6">
          <h2 className="text-xl font-semibold border-b-2 border-blue-600 pb-1 mb-2">
            Profile Summary
          </h2>
